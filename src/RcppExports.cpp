...
// solvebetaCpp
List solvebetaCpp(sp_mat x, vec y, int n, NumericVector tau, double gmma, vec weights, NumericVector groupIndex, double lambdaj, NumericVector wlambda, NumericVector wtau, NumericVector eigenval, NumericVector betaini, int maxIter, double epsilon, int ntau);
