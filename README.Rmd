...
The rqPen package performs penalized quantile regression for LASSO, SCAD and MCP functions including group penalties. Provides a function that automatically generates lambdas and evaluates different models with cross validation or BIC, including a large p version of BIC.

## Installation

You can install the released version of rqPen from [CRAN](https://CRAN.R-project.org) with:
