...
m4 <- rq.group.pen.cv(x,y,groups=g,penalty="gSCAD",norm=1,alg="qicd",nfolds=3)
...
m4 <- rq.group.pen.cv(x,y,groups=g,penalty="gMCP",norm=1,alg="qicd")
...
m4 <- rq.group.pen.cv(x,y,groups=g,penalty="gSCAD",norm=1,alg="qicd",tau=tvals,nfolds=3)
...
m4 <- rq.group.pen.cv(x,y,groups=g,penalty="gMCP",norm=1,alg="qicd",tau=tvals,nfolds=3)
...
m4 <- rq.group.pen.cv(x,y,groups=g,penalty="gMCP",norm=1,alg="qicd",tau=tvals,a=c(3,4,5),nfolds=3)
